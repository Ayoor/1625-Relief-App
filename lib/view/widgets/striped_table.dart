          ...
          child: Container(
            ...
            child: ClipRRect(
              ...
              color: Theme.of(context).brightness == Brightness.dark
                  ? Colors.blueGrey // Softer white shadow in dark mode
                  : Colour("#00334F")
                  ...
                  incomeTable(
                      hrs: (provider.CEHShiftHrs),
                      income: provider.CEHShiftIncome,
                      isOdd: true,
                      projectName: "CEH"),
                  incomeTable(
                      hrs: provider.SGHShiftHrs,
                      income: provider.SGHShiftIncome,
                      projectName: "SGH"),
                  incomeTable(
                      hrs: provider.woodleazeShiftHrs,
                      income: provider.woodleazeShiftIncome,
                      isOdd: true,
                      projectName: "Woodleaze"),
                  incomeTable(
                      hrs: sum(provider.CEHShiftHrs, provider.SGHShiftHrs,
                          provider.woodleazeShiftHrs),
                      income: sum(
                          provider.CEHShiftIncome,
